...
export const performances: CVEntry[] = [
  ...
  },
  {
    ...
    "detail": "Grampian Plains, Victoria. Three-hour improvised audiovisual set."
  },
  {
    "year": "2025",
...
export const awards: CVEntry[] = [
  {
    ...
    "detail": "Nine Inch Nails, “As Alive As You Need Me To Be”, 68th Annual Grammy Awards, 1 February 2026. Visual design for the Grammy-winning single's official music video."
  }
];
...
export const press: CVEntry[] = [
  {
    "year": "2026",
    "title": "Gabriella Brown, “Abstracted organica: The design trend taking root in Naarm, and the designers doing it best”",
