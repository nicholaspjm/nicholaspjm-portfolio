  ...
  blocks: [
    {
      ...
      lead: true,
      paragraphs: [
        "Visual design for the official music video of Nine Inch Nails' “As Alive As You Need Me To Be”. Commissioned by 1080p Studios with creative direction by MTLA Studio.",
      ],
    },
    {
      kind: "text",
