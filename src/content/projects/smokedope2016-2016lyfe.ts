  ...
  blocks: [
    {
      ...
      lead: true,
      paragraphs: [
        "For Lyrical Lemonade's premiere of smokedope2016's “2016LYFE”, I created a series of Gaussian splat visuals built from 3D scans in TouchDesigner. Working with 3D artists, we turned entire scenes into splats that grow, dissolve, and morph between moments.",
      ],
    },
    {
      kind: "text",
    ...
    {
      kind: "video",
      src: "/videos/projects/smokedope2016-2016lyfe/01.mp4",
      ratio: "3/2",
      caption: "Gaussian splat environment",
    },
    {
      kind: "video",
      src: "/videos/projects/smokedope2016-2016lyfe/02.mp4",
      ratio: "3/2",
      autoplay: false,
    ...
    {
      kind: "video",
      src: "/videos/projects/smokedope2016-2016lyfe/04.mp4",
      ratio: "3/2",
      autoplay: false,
    ...
    {
      kind: "video",
      src: "/videos/projects/smokedope2016-2016lyfe/05.mp4",
      ratio: "3/2",
      autoplay: false,
